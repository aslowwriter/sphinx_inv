"""Copied from https://github.com/sphinx-doc/sphinx/blob/e552f8429c3039bc0649a7da82bdfa0df3273c3d/sphinx/util/inventory.py"""
...
if __name__ == "__main__":
    with open("objects.inv", 'rb') as f:
        raw_data = f.read()
        inv = InventoryFile.loads(raw_data, uri="https://docs.kernel.org")
